...
EMPLOYEE_SELECTION = os.getenv("EMPLOYEE_SELECTION", "specific")  # Options: "random", "first", "specific", "interactive"
SPECIFIC_EMPLOYEES = os.getenv("SPECIFIC_EMPLOYEES", "Aashish Solanky,Chandan Kar,Rohith Botu").split(",")  # Comma-separated names
